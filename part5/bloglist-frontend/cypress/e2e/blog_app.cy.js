describe('Blog app', function() {
  ...
  describe('when logged in', function() {
    ...
    describe('and several blogs exist', function () {
      beforeEach(function () {
        cy.createBlog({ title: 'first title', author: 'who knows', url: 'adivina.com', likes: '3' })
        cy.createBlog({ title: 'second title', author: 'who knows', url: 'adivina.com', likes: '3' })
        cy.createBlog({ title: 'third title', author: 'who knows', url: 'adivina.com', likes: '1' })
      })
